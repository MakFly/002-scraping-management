 ...
 */
export class ScraperDomainRegistry {
    constructor() {
    ...
    registerDefaultDomains() {
        ...
        this.registerDomain({
            ...
            selectors: {
                container: '.s-result-item',
                title: '.a-text-normal, #productTitle',
                description: '.a-size-base, #productDescription',
                price: '.a-price .a-offscreen, #priceblock_ourprice, .a-price .a-price-whole',
                url: '.a-link-normal',
                image: '.s-image, #landingImage',
                // Boutons spécifiques à la page produit
                addToCartButton: '#add-to-cart-button',
                buyNowButton: '#buy-now-button',
                outOfStock: '#availability .a-color-price',
                // Sélecteurs pour la page détaillée
                productTitle: '#productTitle',
                productPrice: '#priceblock_ourprice, .a-price .a-offscreen, .a-price .a-price-whole',
                productDescription: '#productDescription p, #feature-bullets .a-list-item'
            },
            requiresJavaScript: true,
            defaultStrategy: ScraperType.PUPPETEER,
        });
        ...
        this.registerDomain({
            ...
            selectors: {
                ...
                nextPage: '.pagination a[data-testid="pagination-nav-next"]',
